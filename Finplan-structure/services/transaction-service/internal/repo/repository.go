...
// ErrNotFound возвращается, когда не найдено ни одной строки
...
// transactionRepo — реализация TransactionRepository
type transactionRepo struct {
	db     *sqlx.DB
	logger *zap.Logger
}

// NewTransactionRepo создает новый экземпляр transactionRepo
