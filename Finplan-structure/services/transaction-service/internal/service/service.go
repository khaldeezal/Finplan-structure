...
// TransactionService описывает интерфейс бизнес-логики транзакций
...
// transactionService реализует бизнес-логику транзакций
...
// NewTransactionService создаёт новый экземпляр сервиса
