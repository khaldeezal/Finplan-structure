...
import (
	...
	"github.com/khaldeezal/Finplan-structure/proto-definitions/gen/auth" // путь поправь, если отличается
	"go.uber.org/zap"
...
// В реальном проекте адрес лучше брать из ENV (например, AUTH_SERVICE_ADDR).
