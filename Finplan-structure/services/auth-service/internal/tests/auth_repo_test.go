...
// TestCreateUser проверяет работу CreateUser c автогенерацией id (id не передаётся явно)
...
// TestCreateUser_DuplicateEmail проверяет работу CreateUser c автогенерацией id (id не передаётся явно)
...
// TestCreateUser_DBError проверяет работу CreateUser c автогенерацией id (id не передаётся явно)
