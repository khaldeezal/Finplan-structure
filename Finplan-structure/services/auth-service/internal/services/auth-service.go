...
// Register хеширует пароль, создаёт нового пользователя и сохраняет его через репозиторий.
...
// generateJWT создаёт JWT-токен с userID и временем жизни 72 часа
...
// Login проверяет email и пароль, и в случае успеха создаёт JWT-токен с userID.
...
// VerifyToken проверяет валидность JWT-токена и возвращает userID из токена.
