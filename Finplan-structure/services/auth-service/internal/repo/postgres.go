...
import (
	...
	"github.com/khaldeezal/Finplan-structure/services/auth-service/internal/models"
	"go.uber.org/zap"
)

// PostgresUserRepository реализует сохранение пользователей в PostgreSQL
...
// CreateUser сохраняет нового пользователя в таблицу users
func (r *PostgresUserRepository) CreateUser(ctx context.Context, user *models.User) (string, error) {
...
// ConnectDB открывает подключение к PostgreSQL и возвращает *sql.DB
...
// GetUserByEmail получает пользователя по email из таблицы users
