...
//go:generate mockgen -destination=mock_auth_service.go -package=tests github.com/khaldeezal/Finplan-structure/services/auth-service/internal/services AuthService
